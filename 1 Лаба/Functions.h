...
double CountInfelicity(const std::vector<double>& x_de_ure, const std::vector<double>& x_de_facto) {
...
void LogVector(const std::vector<double>& vector) {
    std::ofstream fout("logs.txt", std::ios::app);
...
std::vector<std::vector<double>> MultMatrix(const std::vector<std::vector<double>>& a,
...
std::vector<double> MultMat(const std::vector<std::vector<double>>& matrix,
